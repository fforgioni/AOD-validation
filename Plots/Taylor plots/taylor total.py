...
models_folder = 'C:/Users/ferfo/OneDrive/Desktop/total'

# Archivo de referencia
reference_file = 'C:/Users/ferfo/OneDrive/Desktop/total/cams.nc'
reference_variable = 'aod550'
...
for file_name in os.listdir(models_folder):
    if file_name.endswith('.nc') and file_name != 'cams.nc':
        model_file = os.path.join(models_folder, file_name)
        model_data = read_nc_variable(model_file, 'od550aer')
...
# Título
plt.title('Total AOD at 550 nm', pad=40)

# Guardar la figura
plt.savefig('AODtot.png', dpi=300, bbox_inches='tight')
plt.show()
