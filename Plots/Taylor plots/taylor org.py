...
models_folder = 'C:/Users/ferfo/OneDrive/Desktop/org'

# Archivo de referencia
reference_file = 'C:/Users/ferfo/OneDrive/Desktop/org/camsorg.nc'
reference_variable = 'omaod550'
...
for file_name in os.listdir(models_folder):
    if file_name.endswith('.nc') and file_name != 'camsorg.nc':
        model_file = os.path.join(models_folder, file_name)
        model_data = read_nc_variable(model_file, 'od550oa')
...
# Título
plt.title('Organic aerosol at 550 nm', pad=40)

# Guardar la figura
plt.savefig('AODorg.png', dpi=300, bbox_inches='tight')
plt.show()
