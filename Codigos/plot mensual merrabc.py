# -*- coding: utf-8 -*-
"""
Created on Sun Jul  7 17:41:19 2024
...
file_cams = 'C:/Users/ferfo/OneDrive/Desktop/a/merrabc.nc'
ds_cams = nc.Dataset(file_cams)

# Asumimos que los datos de AOD están en la variable 'TOTEXTTAU_regridded' en el archivo CAMS
aod_cams = ds_cams.variables['TOTEXTTAU_regridded'][:]
...
bounds = np.arange(0, 0.181, 0.010)
...
meses = ['MERRA-2. Enero', 'MERRA-2. Febrero', 'MERRA-2. Marzo', 'MERRA-2. Abril', 'MERRA-2. Mayo', 'MERRA-2. Junio', 'MERRA-2. Julio', 'MERRA-2. Agosto', 'MERRA-2. Septiembre', 'MERRA-2. Octubre', 'MERRA-2. Noviembre', 'MERRA-2. Diciembre']
...
cbar.set_label('Carbono negro 550nm', fontsize=18, labelpad=20)  # Añadir una leyenda a la barra de colores con separación

# Guardar la figura
plt.savefig('C:/Users/ferfo/OneDrive/Desktop/bcmerra.png', dpi=300, bbox_inches='tight')
